...
func renderRunbookShow(rb model.Runbook) string {
	...
	header(&b, "commits", csvOrDash(render.AnchorValues(rb.Anchors, model.AnchorCommit)))
	header(&b, "paths", csvOrDash(render.AnchorValues(rb.Anchors, model.AnchorPath)))
	header(&b, "dirs", csvOrDash(render.AnchorValues(rb.Anchors, model.AnchorDir)))
	header(&b, "branches", csvOrDash(render.AnchorValues(rb.Anchors, model.AnchorBranch)))
