...
// under 2KB, where clients hard-truncate.
...
Orient with status. Call relevant on a path before editing unfamiliar code to surface anchored records. search ranks records across every kind; task_criterion_met and task_criterion_failed carry a note as evidence; sprint_add and project_add roll tasks into the optional planning layer, and project_activate un-archives a project. sync pushes refs and attachment content. IDs accept short prefixes. Prefer these records over loose handoff files in the tree.`
