...
- Open an investigation on a falsifiable suspicion, append evidence after each step, and record the verdict with transition verbs rather than rewriting the title.
