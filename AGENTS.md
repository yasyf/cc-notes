...
jj's git bridge carries only `refs/heads/*` — to move this repo's `refs/cc-notes/*` notes/tasks, run `cc-notes sync` (it drives real git); `jj git push` alone leaves them behind.
