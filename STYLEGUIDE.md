...
The concrete style rules for `cc_notes/`. Target Python 3.13+.
...
if TYPE_CHECKING:
    from cc_notes.models import Record
...
def model_version() -> str:
    from cc_notes.state import RESOURCES
...
from cc_notes.matcher import Matcher
from cc_notes.runner import Runner

# Bad — redundant-alias / __all__ ceremony
from cc_notes.matcher import Matcher as Matcher
